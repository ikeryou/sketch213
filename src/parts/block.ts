...
export class Block extends MyDisplay {
  ...
  constructor(opt:any) {
    ...
    const color:Color = new Color(Util.instance.random(0,1), Util.instance.random(0,1), Util.instance.random(0,1));
    ...
    img.src = Conf.instance.PATH_IMG + 'sample-' + (opt.id % 3) + '.png';
  }
